...
|---|---|---|---|
| [US-1](./US-1-never-damage-real-data.md) | The seed never damages real data | Ready | T-1..T-2 in `../tasks/` |
| [US-2](./US-2-demo-account.md) | Log in to a fully populated demo account | Ready | T-1..T-4 in `../tasks/` |
