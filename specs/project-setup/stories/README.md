...
| [US-2](./US-2-backend-health-check-skeleton.md) | Backend health-check skeleton | Ready | T-1..T-2 in `../tasks/` |
| [US-3](./US-3-frontend-placeholder-skeleton.md) | Frontend placeholder skeleton | Ready | T-1..T-2 in `../tasks/` |
