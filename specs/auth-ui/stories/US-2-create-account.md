...
- [x] [T-2: `scorePassword` in `packages/shared`](../tasks/AUTH_UI_US-2_T-2-score-password.md)
- [x] [T-3: `PasswordStrengthMeter` component and `--amber` token](../tasks/AUTH_UI_US-2_T-3-password-strength-meter.md)
- [x] [T-4: `AuthScreen` Create account mode: fields, validation, submit, errors](../tasks/AUTH_UI_US-2_T-4-create-account-mode.md)
- [x] [T-5: Serve `/register` from `AuthScreen` and retire `RegisterForm`](../tasks/AUTH_UI_US-2_T-5-register-route-and-retire-register-form.md)
