...
| [US-4](./US-4-performance-chart.md) | Track performance against a benchmark | Done | T-1..T-4 in `../tasks/` |
| [US-5](./US-5-holdings-grid.md) | See every position I hold | Done | T-1..T-3 in `../tasks/` |
| [US-6](./US-6-holdings-management.md) | Add holdings by hand or by CSV | Done | T-1..T-3 in `../tasks/` |
| [US-7](./US-7-advisor-panel.md) | Get the AI advisor's read on my portfolio | Done | T-1..T-5 in `../tasks/` |
