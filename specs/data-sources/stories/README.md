...
|---|---|---|---|
| [US-1](./US-1-see-whats-imported.md) | See what's already imported | Ready | T-1..T-2 in `../tasks/` |
| [US-2](./US-2-import-assets.md) | Import the assets CSV | Ready | T-1 in `../tasks/` |
...
| [US-6](./US-6-import-history.md) | See what was imported before | Ready | T-1 in `../tasks/` |
