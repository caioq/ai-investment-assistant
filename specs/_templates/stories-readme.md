...
Work shared by more than one story (schema/migration shared by several stories, shared test fixtures, etc.) lives in `../tasks/<MODULE>_SHARED_T-<T>-<short-task-title>.md`, referenced by every story it serves — never duplicated per story.
